...
class FormPosterMessage extends Component {
	...
	constructor(props) {
	    ...
	    this.state = {
	      ...
	      placeholderTitre:"Titre de l'article",
  	...
  	render() {
		...
		//const rawContent = JSON.stringify(convertToRaw(this.state.editorState.getCurrentContent()));
  		...
  		if (this.state.poster==true){
      		return <Redirect to={'/ConfirmationArticle/'}/>;
    		}
		
		return (
			<div className="PageRedigerArticle">
				<Segment>
				    ...
				    <Form.Field>
				     ...
				     <div className="consignePoster">Attention aux fautes d'orthographes !</div>
