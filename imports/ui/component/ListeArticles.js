  ...
  render() {
	...
	let age = Math.round(diff / 31536000000);
		...
		return (
			...
			<Link to={'/singleArticle/' + this.props.message._id} >
	  			<Segment color={colorSexe=="pink" ?
		  			...
		  			<Comment>
	      				<Comment.Content>
							...
							<div className="IconListeArticle">
								<div className="textIcon">{this.props.message.nbrReponse}</div>
	         					<Img className="iconMenu" src="/comment.png"/>
							</div>
							<div className="IconListeArticle">
								<div className="textIcon">{this.props.message.votes}</div>
	         					<Img className="iconMenu" src="/thumbs-up.png"/>
							</div>
							<div className="IconListeArticle">
							<div className="textIcon">{this.props.message.vues}</div>
	         					<Img className="iconMenu" src="/eye.png"/>
							</div>

							<p className="categorieArticles">
...
export default ListeArticles =  withTracker(({ id }) => {
