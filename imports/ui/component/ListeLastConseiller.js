...
class ListeLastConseiller extends Component {
	...
	breaklines(){
		let text = this.props.message.presentation;
		if(text){
			var message = text.substring(0, 120);
			return message
		}
	}
...
ListeLastConseiller.propTypes = {
        message: PropTypes.object.isRequired,
    };

export default ListeLastConseiller =  withTracker(() => {
  return {
  };
})(ListeLastConseiller);