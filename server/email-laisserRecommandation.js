  			...
  			<Box>
				<Item>	  					  			
				  	<Item style={style.text}>
				  		Les conseils de {props.name} ont-ils été utiles?<br />
				  		Laisse lui une recommandation pour donner ton avis.		
				  	</Item>
			  	</Item>
             ...
             <Box>
              	...
              	<Item style={style.BackgroundBottom}>
		  			<Span style={style.LinkBottom}>
				  		<A style={style.link} href="https://www.kurbys.com/">Laisser une recommandation</A>
			  		</Span>
				</Item>
...
export const EmailObtenirRecommandation = function(name){
  return renderEmail(<EmailObtenirRecommandationTemplate name={name}/>);
}